...
# keep original function in case you still need synthetic-data experiments
def make_dataset(
    data_path: str,
...
# NEW: imputation dataset loader
# does NOT append y into X
def make_dataset_impute(
    data_path: str,
    T: lib.Transformations,
    change_val: bool
):
    ...
    for split in ['train', 'val', 'test']:
        ...
        # keep y separate; do NOT inject it into X
        y[split] = y_t
